...
INSERT INTO `easyii_guestbook` (`guestbook_id`, `name`, `title`, `text`, `answer`, `email`, `time`, `ip`, `new`, `status`) VALUES
	...
	(10, 'цйуй', '', 'qwqwqw', NULL, 'qweer@mail.ru', 1475319795, '127.0.0.1', 1, 1),
	(11, 'qwe', '', 'dsfsdfsf', NULL, 'qweer@mail.ru', 1475320344, '127.0.0.1', 1, 1),
	(12, 'йцу', '', 'qwwqwrqe', NULL, 'qweer@mail.ru', 1475320806, '127.0.0.1', 1, 1),
	(13, 'ыфвфыв', '', 'ЛВВЛВЛВЛВЛ', NULL, 'xcdc@2DDD.SS', 1475495521, '127.0.0.1', 1, 1),
	(14, 'ывава', '', 'тест тест', NULL, 'asdf@asd.ss', 1475496221, '127.0.0.1', 1, 1),
	(15, 'ыуквывс', '', 'фывцувс', NULL, 'qwee@ddd.fg', 1475498813, '127.0.0.1', 1, 1),
	(16, 'qwqw', '', 'zxzx', NULL, 'qwee@ddd.fg', 1475503373, '127.0.0.1', 1, 1),
	(17, 'qw', '', 'qw', NULL, 'qwee@ddd.fg', 1475503513, '127.0.0.1', 1, 1),
	(18, 'qw', '', 'qqq', NULL, 'qwee@ddd.fg', 1475504399, '127.0.0.1', 1, 1),
	(19, 'qww', '', 'wwss', NULL, 'qwee@ddd.fg', 1475506363, '127.0.0.1', 1, 1),
	(20, 'сергей', '', 'qww', NULL, 'qwee@ddd.fg', 1475507800, '127.0.0.1', 1, 1),
